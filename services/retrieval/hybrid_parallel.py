...
# الثابت الرياضي RRF_K = 60. هذا الرقم ليس عشوائياً، بل هو الرقم القياسي المعياري المتفق عليه في أبحاث استرجاع المعلومات (Information Retrieval)، حيث يضمن عدم طغيان الوثائق التي تظهر في المراكز الأولى فقط على الحسابات، ويعطي فرصة للوثائق التي تتفق عليها كل المحركات في مراكز متوسطة.
RRF_K = 60
